...
namespace ff7r
{
	BWeaponHitEffectScript::BWeaponHitEffectScript()
		: Script(SCRIPT_TYPE::BWEAPONHITEFFECTSCRIPT)
		, duration(0.f)
	{
	}
	...
	void BWeaponHitEffectScript::Awake()
	{
		...
		module_data.particle_cnt_max = 20;
	...
	void BWeaponHitEffectScript::Tick()
	{
	...
	void BWeaponHitEffectScript::OnEnable()
	{
	}

	void BWeaponHitEffectScript::SetDir(vec3 _dir)
	{
