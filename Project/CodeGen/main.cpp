...
int main()
{
	...
	fwprintf_s(pFile, L"namespace ff7r\n");
	fwprintf_s(pFile, L"{\n");
	...
	// 두번째 함수 작성
	fwprintf_s(pFile, L"Script * ScriptMgr::GetScript(const wstring& _strScriptName)\n{\n");
	...
	// 세번째 함수
	fwprintf_s(pFile, L"Script * ScriptMgr::GetScript(UINT _iScriptType)\n{\n");
	...
	// 네번째 함수
	fwprintf_s(pFile, L"const wchar_t * ScriptMgr::GetScriptName(Script * _pScript)\n{\n");
